...
Widget AddressButton(
    ...
    Function()? onTap,
    Widget? prefixIcon,
    String hintText = 'Куда?',
    bool showAddressName = true}) {
        ...
        child: Row(
          children: [
            ...
            Flexible(
                fit: FlexFit.loose,
                child: Text(
                  showAddressName ? addressModel?.name ?? text : text,
                  style: addressModel == null
                      ? AppStyle.hintText16.copyWith(fontSize: 14)
                      : AppStyle.black14,
