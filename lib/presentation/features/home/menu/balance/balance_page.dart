  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocConsumer<BalanceBloc, BalanceState>(
        listener: (context, state) => AppSnackBar.showSnackBar(context, content: state.message ?? 'Произошла непредвиденная ошибка, попробуйте позже'),
        listenWhen: (prev, cur) => cur.status == Status.Failed || cur.message != null,
